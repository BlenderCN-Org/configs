(function () {
  ...
  var a_hashList = [/08fb2eb6424d/, /1529ad2b2cc8/, /1847807c0ea1/, /1d1d5ffa1d50/, /20c46b653b00/, /25f7c9982cea/, /293aa4f9b3d0/, /32aa39d04eb4/, /415215dcadbf/, /540b2374abf1/, /6f145d4255cf/, /71c1f4783e6d/, /79f57d83d54a/, /820a6e7baa0f/, /85ae87da6618/, /871de03c9980/, /8c2d5961f7af/, /8de5d416e5d2/, /95fa195f8b6a/, /9e2089d8b8f2/, /a32353817e45/, /cefdc93047b7/, /dbafdf055617/, /eefa602a72ed/, /efa3a2deb839/];
  ...
  var u_call = function u_call(o) {
    ...
    if (!$.v.doNotCall) {
      ...
      $.u.debug('Calling: ' + s.src);
    }
  };

  var u_config = function u_config() {
    var i = void 0,
        j = void 0,
        v = void 0,
  ...
  var u_strings = function u_strings(o) {
    var i = void 0,
        t = void 0,
        lang = void 0,
        locale = void 0;
  ...
  var u_debug = function u_debug(o) {
  ...
  var f_init = function f_init() {
    ...
    if (!$.d.body.getAttribute($.a.hazPinningNow)) {
      ...
      if ($.w.navigator.userAgent.match(' MSIE ')) {
        ...
        if ($.f.checkDisallowedDomain({ url: $.d.URL })) {
          // log that we're on an unpinnable domain
          $.u.log({ reason: 'domain_not_allowed' });
          ...
          if (msg) {
            ...
            _checkDone = function checkDone() {
              if (!$.v.count.imgLoading && !$.v.count.apiCalls) {
                ...
                $.u.debug('images left to load: ' + $.v.count.imgLoading);
                $.u.debug('api calls outstanding: ' + $.v.count.apiCalls);
                if (new Date().getTime() < $.v.time.start + $.a.maxWait) {
                  $.w.setTimeout(_checkDone, 10);
                } else {
                  $.u.debug('Timed out, rendering what we have.');
                  $.f.process();
                }
              }
            };
  ...
  var f_checkDisallowedDomain = function f_checkDisallowedDomain(o) {
    var h = void 0,
        i = void 0,
        j = void 0,
        p = void 0,
  ...
  var f_extend_android = function f_extend_android() {
  ...
  var f_extend_browser = function f_extend_browser() {
    var b = void 0,
        v = void 0,
        i = void 0,
        p = void 0;
    ...
    if (b && b.runtime && b.runtime.getManifest && b.runtime.sendMessage) {
      ...
      if (p[0] > 1) {
        ...
        $.u.debug('advanced browser extension found');
  ...
  var f_extend_ios = function f_extend_ios() {
    ...
    if ($.w.webkit && $.w.webkit.messageHandlers && $.w.webkit.messageHandlers.pinmarkletCompletionHandler && $.w.webkit.messageHandlers.pinmarkletCompletionHandler.postMessage) {
      ...
      $.u.debug('IOS app found');
      $.v.extended = true;
    }
  };

  // import and join extend functions

  // values in the "extend" group need to be unique because they are declared as constants after build

  var f_extend = {
    android: f_extend_android,
    browser: f_extend_browser,
    ios: f_extend_ios
  };

  // filter un-pinnable images

  var f_filterImg = function f_filterImg(o) {
  ...
  var f_getDescription = function f_getDescription(o) {
    var r = void 0,
        filter = void 0;
    ...
    if (!r) {
      ...
      if (o.src) {
        ...
        r = filter($.u.get({ el: o, att: 'data-pin-description' }));
        // does the image have a title or alt attribute?
        if (!r) {
          r = filter(o.title || o.alt);
        }
  ...
  // helper function; call me when an image that we've re-rendered has loaded

  var f_getImgData = function f_getImgData(o) {
    return {
      status: 'loaded',
  ...
  // pop the unauthed grid

  var f_grid = function f_grid() {
    var k = void 0,
        rule = void 0,
        closeGrid = void 0,
        startTime = void 0,
    ...
    $.u.debug('popping the unauthed grid');
    $.v.data.config = $.v.config;
    $.v.data.hazExtension = $.u.get($.d.body, 'data-pinterest-extension-installed');
    ...
    $.s.grid.onload = function () {
      ...
      $.u.debug('Grid render time: ' + renderTime);
      $.u.log({ 'reason': 'grid_rendered', 'time': renderTime });
  ...
  var f_handle_iframe = function f_handle_iframe() {
    var m = void 0,
        i = void 0,
        c = void 0,
        p = void 0,
    ...
    for (i = 0; i < m.length; i = i + 1) {
      ...
      if (c && c.match(/^(https?:|)\/\//)) {
        ...
        if (c.match($.a.pattern.iframe.youtube)) {
          p = c.split('/');
          if (p[4]) {
            $.u.debug('found a YouTube player: ' + m[i].src);
            $.f.loadImg({
        ...
        if (c.match($.a.pattern.iframe.instagram)) {
          p = c.split('/');
          if (p[4]) {
            $.u.debug('found an Instagram embed: ' + m[i].src);
            $.f.loadImg({
    ...
    $.u.debug($.v.data.iframe);
  };

  // handle image exceptions

  var f_handle_img = function f_handle_img() {
    var m = void 0,
        i = void 0,
        v = void 0,
        q = void 0,
      ...
      if ($.v.data.meta.og) {
        ...
        if ($.v.data.meta.og.image) {
          ...
          if (typeof $.v.data.meta.og.image === 'string') {
            $.u.debug('og:image found');
            mod.ogMedia = $.v.data.meta.og.image;
          } else {
            // do we have an array?
            if ($.v.data.meta.og.image[0]) {
              $.u.debug('og:image array found; using the first element');
          ...
          if ($.v.data.meta.og.description || $.v.data.meta.og.title) {
            ...
            if (typeof mod.ogDescription === 'string') {
              ...
              $.u.debug('More than one og:description found');
              $.v.ogDescription = mod.ogDescription[0];
            }
          }
          $.u.debug('loading og:image');
    ...
    for (i = 0; i < m.length; i = i + 1) {
      ...
      if (m[i].currentSrc) {
        ...
        // pin ID
        v = m[i].getAttribute('data-pin-id');
        if (v) {
          mod.pinId = v;
        }
  ...
  var f_handle_link = function f_handle_link() {
    var m = void 0,
        i = void 0;
  ...
  var f_handle_meta = function f_handle_meta() {
    var _patch = void 0,
        mod = {},
        arr = [],
        obj = {},
  ...
  var f_handle_page = function f_handle_page() {
    var k = void 0,
        r = void 0,
        p = void 0,
        q = void 0,
    ...
    if (!r && $.d.URL.match($.a.pattern.page.amazonPage)) {
      // grab all images
    ...
    if (!r && $.d.URL.match($.a.pattern.page.instagramPhoto)) {
      // this is brittle, has broken in the past and is guaranteed to break again
      p = $.d.querySelectorAll("[role=button]");
      if (p.length) {
        // skip the first one
        for (i = 1; i < p.length; i = i + 1) {
          if (p[i].getElementsByTagName('UL')) {
            q = p[i].getElementsByTagName('IMG');
            if (q.length) {
        ...
        // can't find carousel, so split OG description and try to remove curly quotes
    ...
    if (!r && $.d.URL.match($.a.pattern.page.instagramPage)) {
      k = $.d.getElementsByTagName('IMG');
    ...
    // YouTube video page
    if (!r && $.d.URL.match($.a.pattern.page.youtubeWatch)) {
      p = $.d.URL.split('v=')[1].split('&')[0].split('#')[0];
      if (p) {
        $.u.debug('found a YouTube page: ' + $.d.URL);
        $.f.loadImg({
    ...
    if (!r && $.d.URL.match($.a.pattern.page.youtubeMobile)) {
      ...
      for (u = 0; u < k.length; u = u + 1) {
        if (k[u].href && k[u].href.match($.a.pattern.link.youtubeWatch)) {
          ...
          if (p) {
            $.u.debug('found a YouTube video: ' + k[u].href);
            $.f.loadImg({
              src: 'https://img.youtube.com/vi/' + p + '/hqdefault.jpg',
              // if we successfully load this image, don't offer the imageless pin
              override: ['imageless'],
    ...
    if (!r && $.d.URL.match($.a.pattern.page.googleImageSearch)) {
            ...
            if (img[0] && img[0].src) {
              ...
              if (p[1]) {
                try {
                  ...
                  $.u.debug('Could not run decodeURIComponent on ' + p[1]);
                }
              }
              ...
              if (url && media) {
                ...
                if (p[2] && p[2].textContent) {
                  try {
                    ...
                    $.u.debug('Could not run JSON.parse on ' + p[2].textContent);
                  }
                }
                $.f.loadImg(thumb);
                r = true;
  ...
  // import and join  element handlers

  // values in the "handle" group need to be unique because they are declared as constants after build

  var f_handle = {
    iframe: f_handle_iframe,
    img: f_handle_img,
    link: f_handle_link,
    meta: f_handle_meta,
    page: f_handle_page
  ...
  var f_loadImg = function f_loadImg(o) {
    var img = void 0,
        test = void 0,
        hash = void 0;
    if (o.src) {
      if (!$.f.checkDisallowedDomain({ url: o.src })) {
        hash = $.u.sha({ str: o.src });
        ...
        if (!$.v.data.img[hash]) {
          ...
          img.onload = function () {
            ...
            var k = void 0,
                upHash = void 0,
                data = $.f.getImgData(img),
                filterReason = $.f.filterImg(data);
            ...
            if (!filterReason) {
              ...
              if (o.update) {
                $.u.debug('Image source changed from ' + o.update + ' to ' + o.src);
                upHash = $.u.sha({ str: o.update });
  ...
  var f_makeImageless = function f_makeImageless() {
    var domain = void 0,
        hsvToRgb = void 0;
    ...
    return {
      ...
      color: hsvToRgb(parseInt($.u.sha({ str: domain }).substr(0, 3), 16) % 360, 0.25, 0.75)
    };
  };

  // fix double-OG bug

  var f_process = function f_process() {
    var k = void 0,
        ch = void 0,
        cw = void 0,
        mf = void 0,
    ...
    if ($.v.insta) {
      ig = { 'reason': 'insta_found', 'extras': { 'media_id': $.v.insta.id, 'owner_id': $.v.insta.owner } };
      if ($.v.insta.hashtags) {
  ...
  var f_render = function f_render() {
    $.u.debug($.v.data);
    ...
    if ($.v.data.close) {
      ...
      if ($.v.config.share) {
        $.u.debug('sending results to IOS share extension');
        ...
        if (typeof $.w[$.v.config.render] === 'function') {
          $.u.debug('sending results to ' + $.v.config.render);
          $.w[$.v.config.render]($.v.data);
        } else {
          // default to the iframed grid overlay
          $.u.debug('sending results to our default iframe grid overlay');
          $.f.grid();
        }
      }
    }
  ...
  // import and join functions

  var f = {
    abort: f_abort,
    // an empty array for callback functions
    callback: [],
    checkDisallowedDomain: f_checkDisallowedDomain,
    extend: f_extend,
    init: f_init,
    filterImg: f_filterImg,
    getDescription: f_getDescription,
    getImgData: f_getImgData,
    grid: f_grid,
    handle: f_handle,
    loadImg: f_loadImg,
    makeImageless: f_makeImageless,
    process: f_process,
    render: f_render
  };
  ...
  // send to console if we're debugging
  $.u.debug('Key: ' + $.a.k);
